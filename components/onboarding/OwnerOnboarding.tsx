...
const AddressPinPicker = dynamic(
    ...
    ),
  {
    ssr: false,
    loading: () => (
      <div className="h-64 rounded-2xl bg-[#f0ede8] animate-pulse" />
    ),
  },
);
...
const RETAILER_FEATURES = [
  {
    ...
    text: "Public storefront for all customers",
  },
  {
    icon: <TrendingUp className="h-4 w-4" />,
    text: "Daily sales & revenue tracking",
  },
  {
    icon: <Users className="h-4 w-4" />,
    text: "Customer credit (Udhar) management",
  },
  {
    icon: <Package className="h-4 w-4" />,
    text: "Product inventory with alerts",
  },
];
...
const WHOLESALE_FEATURES = [
  {
    ...
    text: "Bulk order management & MOQ settings",
  },
  {
    icon: <Building2 className="h-4 w-4" />,
    text: "B2B storefront with quote requests",
  },
  {
    icon: <TrendingUp className="h-4 w-4" />,
    text: "Volume pricing & tiered discounts",
  },
  {
    icon: <Users className="h-4 w-4" />,
    text: "Business client relationship tools",
  },
];
...
export function OwnerOnboarding() {
  ...
  // Step 0
  const [businessType, setBusinessType] = useState<"retailer" | "wholesale">(
    "retailer",
  );
  ...
  const handleKYCResult = useCallback(
    (status: KYCStatus, confidence: number, file: File | null) => {
      setKycStatus(status);
  ...
  function validateStep(step: number): string | null {
    ...
    if (step === 2) {
      ...
      if (kycStatus === "scanning")
        return "Please wait for the document scan to complete.";
      if (kycStatus === "error")
        return "Document scan failed. Please upload a clearer image.";
    }
    return null;
  }
  ...
  async function uploadToStorage(
    ...
    const {
      data: { publicUrl },
    } = supabase.storage.from("shop_assets").getPublicUrl(data.path);
    return publicUrl;
  }
        ...
        <div className="bg-[#27324A] p-5 sm:p-8 text-white shrink-0">
          ...
          <div className="hidden sm:flex justify-between mt-2 text-[9px] font-bold text-white/50 uppercase tracking-widest">
            {STEPS.map((step, idx) => (
              <span
                key={step}
                className={idx <= currentStep ? "text-[#D8C99A]" : ""}
              >
                {step}
              </span>
            ))}
            ...
            <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-right-4">
              <div>
                ...
                <p className="text-sm text-[#746E73] mt-1">
                  Choose how you primarily operate.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                >
                  ...
                  <p className="text-xs text-[#746E73] mb-3">
                    Sell directly to end consumers, both in-store and online.
                  </p>
                ...
                >
                  ...
                  <p className="text-xs text-[#746E73] mb-3">
                    Sell in bulk to businesses and retailers with MOQ
                    requirements.
                  </p>
                  <ul className="space-y-1.5">
            ...
            <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-right-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#746E73] font-medium mt-1.5 flex items-center gap-1">
                  ...
                  Customers will use this link to shop from you. Cannot be
                  changed later.
                </p>
              </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-right-4">
              <div>
                ...
                <p className="text-sm text-[#746E73] mt-1">
                  Pin your shop location. Business proof can be submitted now or
              ...
              <div>
                ...
                <p className="text-[10px] text-[#746E73] mt-1.5">
                  Drag the pin, tap the map, or search — address fills
                  automatically.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-[10px] text-[#746E73] mt-2 flex items-start gap-1">
                  ...
                  You can skip this for now. We will email reminders, and owner
                  features require documents after 30 days.
                </p>
              </div>
            </div>
          )}
          ...
          {currentStep === 3 && !result && (
            <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-right-4">
              <div>
                ...
                <p className="text-sm text-[#746E73] mt-1">
                  Everything look correct? Create your shop to go live.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <ReviewRow
                  label="Business Type"
                  value={
                    businessType === "wholesale" ? "Wholesaler" : "Retailer"
                  }
                />
                <ReviewRow
                  label="Category"
                ...
                <ReviewRow
                  label="Logo"
                  value={
                    logoFile ? logoFile.name : "Not uploaded (can add later)"
                  }
                />
                <ReviewRow
                  label="KYC Status"
              ...
              {kycStatus === "pending" && (
                <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-sm text-amber-700 flex items-start gap-2">
                  ...
                  <p>
                    Your shop will be created now. You have 30 days to submit or
                    re-submit business proof from KYC Settings.
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="bg-[#f8f8f7] rounded-2xl p-5 sm:p-6 text-left border border-[#2E3344]/5 max-w-sm mx-auto">
                ...
                <div className="mt-5 pt-5 border-t border-[#2E3344]/5 flex flex-col items-center">
                  ...
                  <p className="text-xs text-[#746E73] mt-2 text-center">
                    Printed QR codes keep working even if you rename your shop
                    later.
                  </p>
                </div>
              </div>
