  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-both">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <section className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300 fill-mode-both">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 snap-x">
              {popularProducts.slice(0, 4).map((product) => (
                <div key={product.id} className="group min-w-[160px] max-w-[160px] snap-start rounded-[1.25rem] border border-[#2E3344]/8 bg-white p-3 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
        ...
        {/* Management Sidebar */}
        <aside className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-500 fill-mode-both">
          <h2 className="text-sm font-bold uppercase tracking-[0.14em] text-[#8D5132] mb-4">
            Manage
          </h2>
