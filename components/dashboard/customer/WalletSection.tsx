...
export function WalletSection({
  ...
  return (
    <div className="rounded-[1.5rem] overflow-hidden border border-[#1E293B]/8 shadow-sm bg-white">
      {/* Balance header */}
      <div className="bg-gradient-to-br from-[#0F172A] to-[#3D4D6B] px-5 py-4">
      ...
      {/* Earn tips */}
      <div className="border-b border-[#1E293B]/8 bg-[#F8FAFC]/50 px-5 py-3">
        <div className="flex items-center gap-2">
          <Gift className="h-4 w-4 text-[#3B82F6] flex-shrink-0" />
          <p className="text-xs text-[#746E73] leading-relaxed">
            <span className="font-semibold text-[#0F172A]">
              Earn 2% cashback
            </span>{" "}
            on every order ·{" "}
            <span className="font-semibold text-[#0F172A]">50 bonus coins</span>{" "}
            on your first scan
          </p>
        </div>
      </div>
      ...
      {recentTransactions.length > 0 ? (
        <div>
          ...
          <div className="divide-y divide-[#1E293B]/6">
