      ...
      <header className="sticky top-0 z-30 bg-white border-b border-gray-100">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            <div
              className="h-9 w-9 rounded-xl bg-gray-100 flex items-center justify-center font-black text-sm shrink-0 overflow-hidden"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        {(shop.hero_headline || shop.hero_subtext) && (
          <div className="py-4">
            ...
            {shop.hero_subtext && (
              <p className="mt-2 text-gray-500">{shop.hero_subtext}</p>
            )}
          </div>
        )}
        ...
        <div className="flex flex-wrap gap-4 text-xs text-gray-400 font-medium border-b border-gray-100 pb-6">
          ...
          {shop.opening_time && (
            <span className="flex items-center gap-1">
              <Clock className="h-3 w-3" /> {shop.opening_time?.slice(0, 5)} –{" "}
        ...
        <div className="flex gap-2 overflow-x-auto hide-scrollbar">
          {categories.map((cat) => (
            <button
              ...
              style={{
                backgroundColor:
                  activeCategory === cat ? themeColor : "transparent",
        ...
        {(() => {
              ...
              {filtered.length === 0 ? (
                ...
                <div className="divide-y divide-gray-100 -my-2">
                  {filtered.map((p) => {
                    ...
                    const cardCls =
                      "flex items-center gap-4 py-4 group hover:bg-gray-50/60 -mx-2 px-2 rounded-xl transition";
                    const body = (
                      <>
                        ...
                        <div className="flex flex-col items-end gap-1.5 shrink-0">
                          ...
                          {cartItem ? (
                            <div
                              className="flex items-center gap-1.5 bg-gray-50 border border-gray-200 rounded-xl p-0.5"
                              onClick={stop}
                            >
                              <button
                                type="button"
                                ...
                                className="h-6 w-6 flex items-center justify-center rounded-lg text-gray-500 hover:bg-gray-200 transition"
                              >
                              ...
                              <button
                                ...
                                className="h-6 w-6 flex items-center justify-center rounded-lg text-white transition"
          ...
          const aboutBlock = shop.description ? (
            <section key="about" className="pt-6 border-t border-gray-100">
              <p className="text-xs font-black uppercase tracking-wider text-gray-300 mb-2">
                About
              </p>
          ...
          const contactBlock =
            shop.phone || shop.whatsapp_number || shop.address ? (
              <section
                key="contact"
                className="pt-6 border-t border-gray-100 space-y-2 text-sm text-gray-600"
              >
                <p className="text-xs font-black uppercase tracking-wider text-gray-300 mb-2">
                  Contact
                </p>
