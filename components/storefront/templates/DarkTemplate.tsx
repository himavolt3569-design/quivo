  ...
  return (
    ...
    >
      ...
      {shop.announcement_active && shop.announcement_text && (
        <div
          className="text-center text-xs font-bold py-3 px-4 tracking-wider"
      ...
      <div className="relative overflow-hidden px-4 sm:px-6 pt-12 pb-16">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          <div
            className="h-16 w-16 rounded-2xl mx-auto mb-5 flex items-center justify-center font-black text-2xl border overflow-hidden"
            style={{
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-6">
        <div
          className="flex items-center gap-3 px-4 rounded-2xl border"
          style={{ backgroundColor: "#1a1a26", borderColor: "#2a2a38" }}
        >
        ...
        <div className="flex gap-2 overflow-x-auto hide-scrollbar">
          {categories.map((cat) => (
            <button
              ...
              style={{
                backgroundColor:
                  activeCategory === cat ? themeColor : "#1a1a26",
              ...
              {filtered.length === 0 ? (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                  {filtered.map((p) => {
                    ...
                    const cardCls =
                      "rounded-2xl overflow-hidden flex flex-col border transition";
                    const cardStyle = {
                    ...
                    const body = (
                      <>
                        <div
                          className="aspect-square flex items-center justify-center font-black text-4xl overflow-hidden relative"
                        ...
                        >
                          ...
                          {cartItem && (
                            <span
                              className="absolute top-2 right-2 h-5 w-5 rounded-full text-[10px] font-black flex items-center justify-center"
                              style={{
                        ...
                        <div className="p-3 flex flex-col flex-1">
                          ...
                          <h3 className="text-xs font-bold text-white line-clamp-2 flex-1">
                            {p.name}
                          </h3>
                          <div className="flex items-center justify-between mt-2">
                            ...
                            {cartItem ? (
                              <div
                                className="flex items-center gap-1 rounded-xl p-0.5 border"
                              ...
                              >
                                <button
                                  ...
                                  className="h-6 w-6 flex items-center justify-center rounded-lg transition font-bold text-gray-400 hover:text-white"
                                >
                                  −
                                </button>
                                ...
                                <button
                                  ...
                                  className="h-6 w-6 flex items-center justify-center rounded-lg transition"
                                  style={{ backgroundColor: themeColor }}
                                >
                                  <Plus
                                    className="h-3 w-3"
                    ...
                    return href ? (
                      ...
                      <div key={p.id} className={cardCls} style={cardStyle}>
                        {body}
                      </div>
                    );
                  })}
