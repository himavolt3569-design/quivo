  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-28">
      ...
      {shop.announcement_active && shop.announcement_text && (
        <div
          className="text-center text-xs font-bold py-2.5 px-4 text-white"
      ...
      >
        ...
        <div className="max-w-5xl mx-auto relative z-10 flex flex-col sm:flex-row gap-5 items-center sm:items-start">
          {/* Logo */}
          <div
            className="h-20 w-20 rounded-2xl bg-white flex items-center justify-center font-black text-3xl shadow-xl shrink-0 overflow-hidden"
          ...
          <div className="flex-1 text-center sm:text-left">
            <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-3">
              ...
              <button
                onClick={handleShare}
                className="flex items-center gap-1.5 px-3 py-1.5 bg-white/15 hover:bg-white/25 rounded-full text-xs font-bold transition"
              >
        ...
        <div className="flex gap-2 overflow-x-auto hide-scrollbar pb-1">
          {categories.map((cat) => (
            <button
              ...
              style={
                activeCategory === cat ? { backgroundColor: themeColor } : {}
              }
            >
              {cat}
            </button>
                  ...
                  {featured.map((p) => {
                    ...
                    const inner = (
                      <>
                        ...
                        {cartItem && (
                          <p
                            className="text-[10px] text-white font-bold px-2 py-0.5 rounded-full mt-1 inline-block"
                            style={{ backgroundColor: themeColor }}
                          >
                    ...
                    const cls =
                      "shrink-0 w-40 bg-white rounded-2xl p-3 border-2 border-transparent hover:border-gray-200 shadow-sm transition text-left block";
                    return href ? (
                      <Link
                        key={p.id}
                        href={href}
                        className={cls}
                        style={{
                          borderColor: cartItem ? themeColor : undefined,
                        }}
                      >
                        {inner}
                      </Link>
                  ...
                  {filtered.map((p) => {
                          ...
                          {cartItem ? (
                            ...
                            >
                              <button
                                ...
                                className="h-7 w-7 rounded-lg flex items-center justify-center hover:bg-gray-100 text-gray-600 text-lg font-bold transition"
                              >
                                −
                              </button>
                              ...
                              <button
                                ...
                                className="h-7 w-7 rounded-lg flex items-center justify-center text-white transition"
                                style={{ backgroundColor: themeColor }}
                              >
                            ...
                            <button
                              ...
                              className="h-8 w-8 rounded-xl flex items-center justify-center text-white transition active:scale-90"
                              style={{ backgroundColor: themeColor }}
                            >
                    ...
                    return href ? (
                      <Link
                        ...
                        className={cardClass}
                        style={{
                          borderColor: cartItem ? themeColor + "80" : undefined,
                        }}
                      >
                        {body}
                      </Link>
