    ...
    >
      ...
      <div className="container relative">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-[1.18fr_0.82fr]">
          <div className="reveal-item overflow-hidden rounded-[2rem] border border-[#1E293B]/8 bg-[#F8FAFC] shadow-xl shadow-[#0F172A]/10">
            <div className="flex flex-col gap-4 border-b border-[#1E293B]/8 bg-[#0F172A] p-5 text-white md:flex-row md:items-center md:justify-between">
              <div>
              ...
              <div className="flex flex-wrap gap-2 text-xs font-semibold">
                ...
                <span className="rounded-full bg-[#D8C99A] px-3 py-2 text-[#0F172A]">
                  1 urgent
                </span>
              </div>
            </div>
                ...
                >
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span
                        className={`rounded-full px-3 py-1 text-xs font-semibold ${order.priority === "Urgent" ? "bg-[#F3E1CB] text-[#8D5132]" : order.priority === "High" ? "bg-[#FFF0D6] text-[#3B82F6]" : "bg-[#E8E3D1] text-[#626A54]"}`}
                      >
                        {order.priority}
                      </span>
                    </div>
                    <h4 className="mt-3 text-lg font-semibold tracking-[-0.015em] text-[#0F172A]">
                      {order.customer}
                    </h4>
                  ...
                  <div className="flex flex-col gap-3">
                    <span className="inline-flex items-center justify-center rounded-full bg-[#F8FAFC] px-3 py-2 text-sm font-semibold text-[#0F172A]">
                      {order.status}
                    </span>
                    <div className="grid grid-cols-2 gap-2 min-w-0">
                      <button className="min-h-10 rounded-full bg-[#3B82F6] px-3 text-xs font-semibold text-white transition hover:bg-[#8E5432] focus:outline-none focus:ring-2 focus:ring-[#3B82F6] focus:ring-offset-2">
                        Accept
                      </button>
                      <button className="min-h-10 rounded-full border border-[#1E293B]/12 bg-white px-3 text-xs font-semibold text-[#0F172A] transition hover:border-[#3B82F6]/40 focus:outline-none focus:ring-2 focus:ring-[#3B82F6] focus:ring-offset-2">
                        Message
                      </button>
                    </div>
                  </div>
          ...
          <aside className="reveal-item rounded-[2rem] border border-[#1E293B]/8 bg-[#0F172A] p-6 text-white shadow-xl shadow-[#0F172A]/16">
            <div className="grid h-13 w-13 place-items-center rounded-2xl bg-[#D8C99A] text-[#0F172A]">
