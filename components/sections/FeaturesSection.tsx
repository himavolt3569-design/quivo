  ...
  return (
    ...
    >
      <div className="container">
        ...
        <div className="reveal-item mt-10 grid gap-3 rounded-[1.35rem] border border-[#1E293B]/8 bg-[#F8FAFC] p-3 shadow-inner shadow-[#0F172A]/5 sm:gap-4 sm:rounded-[2rem] sm:p-4 md:grid-cols-4">
            ...
            return (
              ...
              >
                {index < counterFlow.length - 1 ? (
                  <ArrowRight
                    className="absolute -right-3 top-1/2 z-10 hidden h-6 w-6 -translate-y-1/2 rounded-full bg-[#3B82F6] p-1 text-white md:block"
                    aria-hidden="true"
                  />
                ) : null}
                <div className="flex min-w-0 items-center gap-3">
                  <span className="grid h-11 w-11 place-items-center rounded-2xl bg-[#F1F5F9] text-[#475569]">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              ...
              >
                <div className="feature-icon grid h-13 w-13 place-items-center rounded-2xl bg-[#F1F5F9] text-[#475569]">
