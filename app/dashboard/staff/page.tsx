...
import { StaffShiftsView, type StaffShiftRow } from "@/components/dashboard/staff/StaffShiftsView";
...
export default async function StaffDashboardPage() {
  ...
  const [{ data: profile }, { data: shifts }, { data: linkedStaff }] = await Promise.all([
