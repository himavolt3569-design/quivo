...
export default async function OwnerPage() {
  ...
  if (shopId) {
    const [statsRes, revenueRes, lowStockRes, txnRes, ordersRes] =
      await Promise.all([
        supabase.rpc("get_shop_dashboard_stats", { p_shop_id: shopId }),
        supabase.rpc("get_shop_revenue_by_day", {
          p_shop_id: shopId,
          p_days: 7,
        }),
        supabase
    ...
    revenueChartData = Array.isArray(revenueRes.data)
      ? (revenueRes.data as { day: string; revenue: number }[])
      : [];
